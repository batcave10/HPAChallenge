...
public class Challenge2 {
	...
	public static void main(String[] args) {
		...
		//input[@type='text' and @id='formDate' and @placeholder='2017-05-04']
		...
		//input[@type='text' and @id='formCity' and @placeholder='Seattle']
		...
		//input[@type='text' and @id='formState' and @placeholder='Washington']
		...
		//(//input[@id='formCountry'])[2]
		//input[@type='text' and @id='formDate' and @placeholder='2007-10-10']
		...
		js.executeScript("arguments[0].scrollIntoView();", Element);
		 ...
		 //WebElement ele = driver.findElement(By.xpath("//tbody//tr["+linenum+"]//td[2]//input[1]"));
